...
Biz hali matn kodlash bilan tanish bo'lmaganimiz sababli, kod miqdori to'satdan ko'payib ketgandek tuyulishi mumkin, lekin aslida bu o'qishni oshirish uchun ataylab bo'sh qatorlar bilan kod bo'laklariga ajratilgan, shuning uchun qatorlar soni katta tuyulishi mumkin, agar siz uni diqqat bilan izohlasangiz, unda murakkab tarkib deyarli yo'qligini ko'rasiz.
...
Agar biz blokli kodlashda o‘zgaruvchilarni ishlatgan bo‘lsak, ularning ma’nosi va qo‘llanilishini yaxshi bilamiz. Matnli kodlashga o‘tilganda ham bu ma’no va maqsad umuman o‘zgarmaydi. Faqatgina matnli kodlashda (bu yerda Python) foydalanilganda, shu tilning o‘zgaruvchi ishlatish sintaksisiga amal qilib, foydalanish kifoya.
